...
namespace glm
{
    ...
    {
        ar(CEREAL_NVP(m[0][0]), CEREAL_NVP(m[0][1]), CEREAL_NVP(m[0][2]));
        ar(CEREAL_NVP(m[1][0]), CEREAL_NVP(m[1][1]), CEREAL_NVP(m[1][2]));
        ar(CEREAL_NVP(m[2][0]), CEREAL_NVP(m[2][1]), CEREAL_NVP(m[2][2]));
    }
